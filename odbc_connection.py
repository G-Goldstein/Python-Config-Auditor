...
class odbc_connect:
	def __init__(self, args):
		...
		self.connection_string="Driver={{iSeries Access ODBC Driver}};System={!s};Uid={!s};Pwd={!s};DefaultLibraries={!s};ConnectionType=2".format(self.ip, self.user, args['iseries.password'], self.libl)
