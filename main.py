import ftpconnector.connector as ftpconnector
import smbmodule.connector as smbconnector
import json
...
def collect_audit_for_environment(environment, source_ip, source_shared_directory, source_path, source_username, source_password):
	...
	with ftpconnector.ftp_connector(source_ip, source_username, source_password) as source_connection:
	...
	with smbconnector.smb_connector(globals['audit_machine_ip'], globals['audit_machine_shared_directory'], globals['audit_machine_username'], globals['audit_machine_password']) as save_connection:
